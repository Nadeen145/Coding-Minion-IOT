...
#define EXTRA_FOR_MIN_DISTANCE_FRONT   120  
#define WALL_DISTANCE_FRONT            210

#define MIN_MIN_DISTANCE_SIDE          65   
#define MIN_DISTANCE_SIDE              75
#define MAX_DISTANCE_SIDE              90   
#define MIN_DISTANCE_SIDE_NO_TURN      100       
#define Difference_DISTANCE_SIDE_HALF  7  

#define MIN_DISTANCE_TO_TURN           80       
    
#define MAX_MAX_DISTANCE_SIDE          210    

#define FORWARD_DELAY_CORRECTION       150 
#define RIGHT_DELAY_CORRECTION_R       150   
#define LEFT_DELAY_CORRECTION_R        90   
#define RIGHT_DELAY_CORRECTION_L       150   
#define LEFT_DELAY_CORRECTION_L        120   
